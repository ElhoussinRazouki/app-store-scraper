...
const throttled = require('throttled-request')(axios);
...
const doRequest = (url, headers, requestOptions, limit) => new Promise(function (resolve, reject) {
  ...
  req(Object.assign({url, headers, transformResponse: x => x, validateStatus: status => (status < 500)}, requestOptions)).then(response => {
